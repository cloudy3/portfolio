...
const experiences = [
  ...
  },
  {
    ...
    details: [
      ...
      "Created <span style='color: white;'>React</span> components and used <span style='color: white;'>Redux</span> for State Management",
      "Learnt how to set up a backend server using <span style='color: white;'>Postgres</span> and <span style='color: white;'>Docker</span>",
      "Implemented <span style='color: white;'>Unit Tests</span> using<span style='color: white;'> Mocha, Chai and Sinon</span>",
      "Created UI/UX designs on <span style='color: white;'>Figma</span> for a web portal",
    ],
  },
  {
    title: "Software Engineer Intern",
